...
### 6.3 발현된 씨앗의 종류 (아이 TCI)
| TCI 조합 | 메타포 | 씨앗의 특징 |
| :--- | :--- | :--- |
| **NS High** | **에너지 넘치는 탐험 씨앗** | 새로운 영역을 탐험하며 정원에 활기를 주는 씨앗 |
| **HA High** | **섬세한 아티스트 씨앗** | 주변을 섬세하게 관찰하며 자기만의 결을 가진 씨앗 |
| **RD High** | **다정한 분위기 메이커 씨앗** | 주변과 향기를 나누며 관계의 중심이 되는 씨앗 |
| **P High** | **단단한 노력가 씨앗** | 한 자리에서 묵묵히 뿌리를 내리는 끈기 있는 씨앗 |
