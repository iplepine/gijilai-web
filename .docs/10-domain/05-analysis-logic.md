...
| :--- | :--- | :--- |
| **순한 기질 (Easy)** | **민들레 씨앗** | 어떤 토양에서도 잘 적응하며 평화롭게 싹을 틔우는 유연함 |
| **까다로운 기질 (Difficult)** | **야생 장미 씨앗** | 발아 조건은 섬세하지만 피어났을 때 누구보다 강렬한 독창성 |
| **느린 기질 (Slow)** | **도토리 씨앗** | 발아까지 인내가 필요하지만 결국 굳건한 뿌리를 내리는 내실 |
