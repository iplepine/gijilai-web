...
- **아이의 토양 (Soil)**: 체스 & 토마스 기질 유형. 씨앗이 뿌리 내리고 자라는 환경적 바탕.
- **아이의 씨앗 (Seed)**: 아이의 TCI 차원. 아이가 가진 고유의 DNA와 성장 잠재력.
- **정원의 환경 (Weather)**: 부모의 TCI 차원. 씨앗이 자라나는 대기 상태 (바람, 온도, 습도).
- **가드닝 (Gardening)**: 부모의 양육 활동(햇살, 물). 대기 환경에 맞춰 토양을 가꾸는 과정.
...
### 6.1 토양 분류 (Chess & Thomas)
| 분석 결과 | 메타포 | 시각적 특징 |
| :--- | :--- | :--- |
| **순한 기질 (Easy)** | **안정적인 숲 체험장** | 부드러운 흙, 풍부한 일조량 |
| **까다로운 기질 (Difficult)** | **변화무쌍한 화산지대** | 거친 결, 뜨거운 온도, 섬세한 관리 필요 |
| **느린 기질 (Slow)** | **안개 낀 아침의 호숫가** | 차분한 공기, 예열이 필요한 촉촉한 토양 |

### 6.2 씨앗 분류 (아이 TCI)
| 차원 | 높은 경우 (High) | 낮은 경우 (Low) |
| :--- | :--- | :--- |
| **자극 추구 (NS)** | 새로운 길을 찾아가는 **탐험 씨앗** | 익숙한 곳에 머무는 **뿌리 씨앗** |
| **위험 회피 (HA)** | 조심스럽게 관찰하는 **신중 씨앗** | 겁 없이 뛰어드는 **용기 씨앗** |
| **사회적 민감성 (RD)** | 향기로운 **다정 꽃씨** | 혼자서도 잘 자라는 **독립 나무씨** |
| **지속성 (P)** | 눈보라도 견디는 **단단 씨앗** | 유연하게 방향을 바꾸는 **바람 씨앗** |

### 6.3 환경 및 날씨 분류 (부모 TCI)
| 차원 | 높은 경우 (High) | 낮은 경우 (Low) |
| :--- | :--- | :--- |
| **자극 추구 (NS)** | 활기차게 불어오는 **봄바람** | 잔잔하게 머무는 **미풍** |
| **위험 회피 (HA)** | 서늘하게 보호하는 **그늘진 온도** | 뜨겁고 열정적인 **햇살 온도** |
| **사회적 민감성 (RD)** | 마음을 촉촉하게 적시는 **단비(습도)** | 상쾌하고 보송보송한 **건조한 공기** |
