...
export const CHILD_QUESTIONS: Question[] = [
    ...
    },
    {
        ...
        choices: [
            "매우 예민하게 반응하며 강한 거부감이나 불쾌감을 표현한다.",
            "자극에 민감하게 반응하며 금방 불편해하거나 짜증을 낸다.",
            "잠시 주의를 기울이지만 이내 대수롭지 않게 넘긴다.",
            "자극을 인지하지만 별다른 감정 변화 없이 상황을 받아들인다.",
            "주변 자극에 매우 무던한 편이며 웬만한 소음이나 촉감엔 반응이 없다."
        ],
        reverse: true
    },
    {
    ...
    },
    {
        ...
        choices: [
            ...
            "매우 뿌듯해하며 칭찬받은 행동을 더 잘하려고 애를 쓴다.",
            "주변의 칭찬과 격려가 없으면 활동을 지속할 동기를 얻기 힘들어한다."
        ]
    },
    {
    ...
    },
    {
        ...
        context: "한 가지 놀이나 장난감을 가지고 놀 때, 우리 아이는 얼마나 오래 집중하나요?",
        choices: [
            "하나에 꽂히면 다른 것엔 눈도 안 돌리고 아주 오랫동안 깊이 몰입한다.",
            "대체로 한 가지 놀이를 진득하게 즐기는 편이다.",
            "적당히 즐기다가 흥미가 떨어지면 자연스럽게 다음 놀이로 넘어간다.",
            "익숙해지면 금방 싫증을 느끼고 다른 새로운 놀잇감을 찾으려 한다.",
            "잠시도 한 가지에 가만히 있지 못하고 끊임없이 새로운 자극을 찾아 헤맨다."
        ]
    },
    {
        ...
        choices: [
            "작은 변화에도 크게 당황하며 울거나 거칠게 항의한다.",
            "바뀐 상황이 마음에 들지 않아 한동안 징징대거나 짜증을 낸다.",
            "처음엔 어색해하며 망설이지만 천천히 새로운 상황에 적응한다.",
            "상황이 바뀌어도 금방 적응하며 별다른 불평 없이 잘 따른다.",
            "오히려 새로운 일정을 반기며 어떤 상황이든 유연하게 대처한다."
        ],
        reverse: true
    },
    {
    ...
    },
    {
        ...
        choices: [
            ...
            "피곤하거나 다른 재미있는 놀이가 있어도 자기가 정한 원칙은 반드시 완수한다."
        ]
    },
    {
    ...
    },
    {
        ...
        choices: [
            ...
            "실패할수록 끝까지 성공시키려는 의지가 강해져서 포기하지 않고 도전한다."
        ]
    },
    {
        ...
        choices: [
            ...
            "기본적인 규칙은 따르지만 가끔 상황에 맞춰 변형을 시도한다.",
            "규칙을 금방 지루해하며 자기 마음대로 바꿔서 노는 것을 좋아한다.",
            "정해진 방식에 얽매이는 것을 극도로 싫어하며 항상 독창적인 방식을 고집한다."
        ]
    },
    {
    ...
    },
    {
        ...
        choices: [
            ...
            "아주 작은 꾸중에도 심하게 위축되어 기분을 회복하는 데 시간이 꽤 걸린다."
        ]
    },
    {
        ...
        choices: [
            ...
            "단 한 문장이라도 빼먹으면 마음이 불편해서 어떻게든 끝마쳐야만 직성이 풀린다."
        ]
    },
];
...
export const PARENTING_STYLE_QUESTIONS: Question[] = [
    ...
    {
        id: 50, type: 'PARENTING_STYLE', category: 'Efficacy', facet: '양육자 역할 만족도',
        context: "아이를 재우고 조용히 하루를 돌아보는 순간, 나는?",
        choices: [
            "\"오늘도 괜히 화를 냈네\"라며 심하게 자책하고, 양육자로서의 자신감이 떨어진다.",
            ...
            "양육자로서의 내 모습에 충분히 만족하며, 아이가 크는 과정에서 깊은 충만함을 느낀다."
        ]
    },
];
...
export const PARENT_QUESTIONS: Question[] = [
    ...
    },
    {
        ...
        choices: [
            ...
            "사고가 난 건 아닌지 심한 불안감을 느끼며 아무 일도 손에 잡히지 않는다."
        ]
    },
    // 사회적 민감성 (RD) - Adult
    ...
    },
    {
        ...
        choices: [
            ...
            "자신과의 약속은 웬만하면 지킨다.",
            "매우 피곤하거나 바쁜 상황에서도 정해진 일과는 반드시 수행한다."
        ]
    },
];
