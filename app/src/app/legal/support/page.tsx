...
function SupportContent() {
    ...
    const faqs = [
        ...
        {
            q: "결제를 취소/환불하고 싶어요.",
            a: "웹 구독은 devhohouse@gmail.com으로 환불 사유와 결제 정보를 보내주시면 확인 후 처리합니다. 7일 이내 미사용 건은 전액 환불, 이용 중 환불 요청 건은 남은 미사용 일수 기준으로 부분 환불됩니다. 앱 스토어 결제는 애플/구글 플레이의 환불 정책과 절차가 우선 적용됩니다."
        }
    ];
