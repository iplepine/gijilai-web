...
## 2026-04-23 | 월 구독 환불은 미사용 일자 부분 환불을 제공

- **결정**: 웹 월 구독 환불 정책을 7일 이내 미이용 전액 환불과 결제 주기 내 미사용 일자 부분 환불로 운영한다. 부분 환불은 실제 결제금액을 기준으로 `남은 미사용 일수 / 해당 결제 주기의 총 일수`를 곱해 산정하고, 환불 처리 후 유료 기능 접근은 종료한다.
- **이유**: 토스페이 간편결제 계약 검토에서 구독권 상품의 미사용 일자에 대한 조건부 환불 규정 보완이 요구되었다. 실제 고지 정책과 심사 회신 내용이 일치해야 결제 심사와 운영 민원을 줄일 수 있다.
- **대안**: 7일 이후 환불 불가 유지 — 구독권 부분 환불 기준이 없어 간편결제 심사 요구사항을 충족하기 어렵다.
